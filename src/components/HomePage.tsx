...
const POI_TYPES = {
  supermarket: { type: 'Supermarché', searchTerms: ['supermarket', 'grocery', 'market'] },
  restaurant: { type: 'Restaurant', searchTerms: ['restaurant', 'cafe', 'bistro'] },
  transport: { type: 'Transport',  searchTerms: ['subway', 'bus_station', 'train_station'] },
  park: { type: 'Parc', searchTerms: ['park', 'garden', 'recreation_area'] },
  school: { type: 'École', searchTerms: ['school', 'university', 'college'] },
  pharmacy: { type: 'Pharmacie',  searchTerms: ['pharmacy', 'drugstore'] },
  hospital: { type: 'Hôpital',  searchTerms: ['hospital', 'clinic'] },
  bank: { type: 'Banque',searchTerms: ['bank', 'atm'] },
  shopping: { type: 'Centre commercial', searchTerms: ['mall', 'shopping_center'] },
  church: { type: 'Lieu de culte',  searchTerms: ['church', 'cathedral', 'temple', 'mosque', 'synagogue'] }
};
...
const getFallbackPOIs = (city: string): PointOfInterest[] => {
  ...
  return [
    { type: 'Supermarché', name: 'Carrefour Market', distance: baseDistances.supermarket, distanceDisplay: formatDistance(baseDistances.supermarket) },
    { type: 'Restaurant', name: 'Bistro du Centre', distance: baseDistances.restaurant, distanceDisplay: formatDistance(baseDistances.restaurant) },
    { type: 'Transport', name: 'Station de Métro', distance: baseDistances.transport, distanceDisplay: formatDistance(baseDistances.transport) },
    { type: 'Parc', name: 'Parc Municipal', distance: baseDistances.park, distanceDisplay: formatDistance(baseDistances.park) },
    { type: 'École', name: 'École Primaire', distance: baseDistances.school, distanceDisplay: formatDistance(baseDistances.school)},
    { type: 'Pharmacie', name: 'Pharmacie Centrale', distance: baseDistances.pharmacy, distanceDisplay: formatDistance(baseDistances.pharmacy)},
    { type: 'Lieu de culte', name: 'Église Saint-Pierre', distance: baseDistances.church, distanceDisplay: formatDistance(baseDistances.church) }
  ];
};
